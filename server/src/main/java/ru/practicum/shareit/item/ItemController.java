...
public class ItemController {
    ...
    public ItemResponseDto addItem(@RequestHeader(Constants.USER_ID_HEADER) Long userId, @RequestBody ItemRequestDto itemDto) {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public CommentResponseDto addComment(@RequestHeader(Constants.USER_ID_HEADER) Long userId, @PathVariable long itemId, @RequestBody NewCommentDto dto) {
