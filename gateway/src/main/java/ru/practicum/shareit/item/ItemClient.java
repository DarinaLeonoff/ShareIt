...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItem(long userId, ItemRequest item) {
    ...
    public ResponseEntity<Object> editItem(long userId, ItemUpdateRequest item, long itemId) {
